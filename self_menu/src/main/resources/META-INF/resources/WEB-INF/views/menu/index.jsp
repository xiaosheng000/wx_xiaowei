...
<meta charset="UTF-8">
<title>菜单管理</title>
<link rel="stylesheet" href="/xiaowei_1/menu/css/menu.css"/>
</head>
<body>
...
<script type="text/javascript" src="/xiaowei_1/menu/js/jquery.js"></script>
<script type="text/javascript" src="/xiaowei_1/menu/js/vue.js"></script>
<script type="text/javascript" src="/xiaowei_1/menu/js/menu.js"></script>
