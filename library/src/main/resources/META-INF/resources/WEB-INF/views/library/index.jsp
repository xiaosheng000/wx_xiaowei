...
<meta charset="UTF-8">
<title>图书馆首页</title>
<link href="/xiaowei_1/library/css/main.css" rel="stylesheet"/>
</head>
<body>
	...
	<c:forEach items="${page.content }" var="book">
		<div class="book">
			<div class="col-1">
				<img class="image" src="/xiaowei_1/library/images/${book.image }" />
			</div>
			<span class="col-10 name">${book.name }</span>
			<span class="col-1" style="text-align: right;">
				<a href="/xiaowei_1/library/debit?id=${book.id }" class="button">+</a>
			</span>
		</div>
	</c:forEach>
