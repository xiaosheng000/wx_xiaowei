package org.xwjava.weixin.library.controller;
...
import org.xwjava.weixin.library.service.LibraryService;

@Controller
@RequestMapping("/xiaowei_1/library/debit")
...
public class DebitController {
	...
	public String debit(@RequestParam("id") String id, WebRequest request) {
		...
		return "redirect:/xiaowei_1/library/debit/list";
	}
